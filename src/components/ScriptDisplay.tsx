...
export function ScriptDisplay({ script, onContinue }: ScriptDisplayProps) {
    ...
    >
      ...
      <div className="mt-6">
        <button
          ...
          className="flex w-full items-center justify-between gap-2 rounded-xl py-2 text-left text-sm font-medium text-foreground transition-colors hover:text-accent"
